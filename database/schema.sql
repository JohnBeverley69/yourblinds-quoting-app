-- =============================================================================
-- YourBlinds quoting application schema (per-client model)
-- Target: MySQL 8.0+ / InnoDB / utf8mb4
--
-- Decisions locked in:
--   1. Naming: clients = trade businesses; customers = end-customers
--   2. Locale: UK (GBP, 20% VAT, county/postcode)
--   3. Pricing: PER-CLIENT — every client owns its own product_groups,
--      products, price_tables, price_table_rows, vertical_fabrics. There is
--      NO global catalogue. client_id is on every catalogue table.
--   4. End-customers: dedicated customers table + denormalised end_customer_*
--      snapshot on quotes for stability after sending
--   5. quote_items: hybrid — multi-line description_text + structured columns
--   6. client_users.role: 6-role enum (admin/owner/office/sales/agent/readonly)
--   7. quote.status: includes 'ordered'
...
--   appointments     -> clients, client_users, customers
...
-- Every catalogue table carries a client_id. There is no global catalogue.
-- ===========================================================================
