...
return [
        ...
        'lede'    => 'The Pipeline is the <b>same jobs</b> as your Orders <b>List</b> &mdash; just drawn as a <b>board</b>. Seven columns,
                      left to right: <em>Quote, Declined, Accepted, Ordered, Fitted, Invoiced, Paid</em>. Under each one it tells you
                      how many jobs are sitting there and how much money. You <b>read</b> this screen; you don&rsquo;t move cards on it.
        ...
        'css'     => '
          ...
          .gd .lnew{ display:inline-block; background:var(--accent); color:#fff; border-radius:6px; padding:.1rem .45rem;
                     font-size:.58rem; font-weight:700; margin-bottom:.3rem; }
          ...
          <div class="demo-shell">
            ...
            <div class="app">
              <div class="side">
                ...
                <a>Dashboard</a><a>Calendar</a><a class="on">Pipeline</a><a>Customers</a><a>Products</a><a>Settings</a>
              </div>
              <div class="stage" id="gdStage" data-step="0">
                ...
                <div class="plsc scC">
                  <div class="zwrap">
                    <div class="plzoom">
                      ...
                      <div class="znum">Q-1042 <span style="color:var(--faint)">&middot; LS16 5PT</span></div>
                ...
                <div class="plsc scD">
                  <div class="flagcols">
                    <div class="flagcol">
                      ...
                      <div class="bigcard">
                        ...
                        <div class="plnum">Q-1041 &middot; BD18 3HN</div>
                    ...
                    <div class="flagcol">
                      ...
                      <div class="bigcard padchip">
                        ...
                        <div class="plnum">Q-1039 &middot; HX3 0PT</div>
                    ...
                    <div class="flagcol">
                      ...
                      <div class="bigcard padchip">
                        <span class="plchip is-part" title="&pound;120.00 received of &pound;480.00">Part paid</span>
                        <div class="plname">A Brennan</div>
                        <div class="plnum">Q-1024 &middot; LS1 4AP</div>
                  ...
                  <p class="plnote"><b>Not sent</b> sits on the card body; the <b>Paid</b> / <b>Part paid</b> chip is pinned to the
                     top-right corner and shows in <em>any</em> column. <b>&pound;X outstanding</b> appears only in <b>Invoiced</b>.</p>
                </div>
                  ...
                  <div class="zwrap">
                    <div class="nodrag">
                      <div class="plzoom" style="width:11rem">
                        ...
                        <div class="znum">Q-1039 &middot; HX3 0PT</div>
                ...
                <div class="plsc scH">
                  <div class="cmp">
                    ...
                    <div class="cmpcol">
                      <div class="flagcap">List &mdash; the work</div>
                      <div class="listmock">
                        <span class="lnew">+ New quote</span>
                        <div class="lchips">
                          <span class="lchip on">All</span><span class="lchip">Accepted (2)</span><span class="lchip">Ordered (3)</span>
                          <span class="lchip">Fitted (1)</span><span class="lchip">Invoiced (1)</span><span class="lchip">Paid (0)</span>
                          <span class="lchip">&#128451; Archived (7)</span>
                        </div>
                        <div class="lrow">Q-1042 &middot; Mrs J Hartley &middot; Quote</div>
                        <div class="lrow">Q-1039 &middot; R Ellis &middot; Accepted</div>
                        <div class="lrow">Q-1033 &middot; Kaur &amp; Sons &middot; Ordered</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="caps">
                  <b class="c1"><span class="n">1</span> Work &rarr; Pipeline. Same jobs as the List, drawn as a board.</b>
        ...
        'body'    => '
          <p>The <b>Pipeline</b> lives in the sidebar under <b>Work</b>, between <b>Calendar</b> and <b>Factory</b>. It is <b>not</b> a
             second set of records to keep up to date &mdash; it is exactly the same jobs as your <b>Orders</b> list, drawn as a board
             instead of a table. Under the page title you&rsquo;ll find two little buttons in a grey tray, <b>List</b> and <b>Pipeline</b>,
             and they swap between the two views of the very same data. Rule of thumb: the <b>List</b> is for finding and working one job;
             the <b>board</b> is for seeing the shape of the whole week in one glance &mdash; where the jobs are stacked up, and where the
             money is sitting.</p>
          ...
          <ul class="steps">
            ...
            <li><b>Under each column name: the count, then the money.</b> Bold number = how many jobs are sitting in that stage. The grey
                ...
                <b>&ldquo;View costs&rdquo;</b>, <b>every &pound; on this page disappears</b> &mdash; the summary, the column totals, the
                card totals and the outstanding line &mdash; and you just see counts. Nothing is broken; it&rsquo;s deliberate.</li>
            ...
            <li><b>Three flags do the real work.</b> <b>Not sent</b> &mdash; a small amber pill on the card body, only on a draft, titled
                ...
                <code>&pound;120.00 received of &pound;480.00</code>. And <b>&pound;360.00 outstanding</b> in red, which appears
          ...
          <ul class="steps">
            ...
            <li><b>The fitting appointment is marked completed</b> on the calendar &mdash; the job moves to <b>Fitted</b>:
                <code>Status updated to completed. Linked quote Q-1042 advanced to &ldquo;fitted&rdquo;.</code></li>
        ...
        'script'  => [
            ['0:00', 'Work → Pipeline; the List | Pipeline tray.',   'The Pipeline lives in the sidebar under Work, between Calendar and Factory. It is the same jobs as your Orders list — nothing separate, nothing extra to keep up to date. The list is for finding one job; the board is for seeing the shape of the whole week at once. The two little buttons at the top, List and Pipeline, swap between them.', 1],
            ...
            ['2:22', 'Board for the shape, List for the work.',      'Use the board when you want the shape of things — where the money is stuck, who has not been chased, what is waiting to go out. Use the list when you want to work: it splits quotes from orders, separates retail from trade, has your archive, and lets you tick several jobs at once. The board keeps itself up to date — it checks every twenty seconds and refreshes itself only when something has genuinely moved, so leave it open on a second screen.', 8],
        ],
];
