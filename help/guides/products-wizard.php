...
return [
            ...
            <div class="app">
              ...
              <div class="stage" id="gdStage" data-step="0">
                ...
                <div class="wsc scC">
                  ...
                  <div class="okbanner"><b>&check;</b> Added 4 systems. Skipped 1 (already on this product).</div>
                  <div class="wlist">
                    ...
                    <div class="wrow"><span class="ok">&check;</span> <b>FW 35mm String</b><span class="rm">Remove</span></div>
                    <div class="wrow"><span class="ok">&check;</span> <b>FW 50mm Tape</b><span class="rm">Remove</span></div>
                  </div>
                  <div class="fld"><label>One system per line (paste from Excel or type)</label>
                    <div class="ta wta f3"><span class="ph">Standard<br>Motorised<br>FW 35mm String<br>FW 50mm Tape<br>&hellip;</span><span class="val">Standard<br>Motorised<br>FW 35mm String<br>FW 50mm Tape</span></div></div>
                ...
                <div class="wsc scD">
                  ...
                  <p class="wlede">Add at least one fabric with a <b>band code</b>. Common codes:
                     <code>A</code>/<code>B</code>/<code>C</code> from a supplier price list, or words like
                     <code>Standard</code>/<code>Special</code>.</p>
                  <div class="okbanner"><b>&check;</b> Added 42 to Band A (all systems).</div>
                  ...
                  <div class="wgrid3">
                    <div class="fld"><label>Band <span class="req">*</span></label>
                      ...
                      <div class="wdl"><span class="on">A</span><span>B</span><span>Special</span></div></div>
                    ...
                    <div class="fld"><label>Fabrics (one per line or comma-separated &mdash; paste from Excel or type)</label>
                      <div class="ta wta f4"><span class="ph">Plain White<br>Plain Cream<br>Plain Black<br>Silver<br>&hellip;</span><span class="val">Plain White<br>Plain Cream<br>Silver<br>Anthracite</span></div></div>
                  </div>
                  <div class="wbtnrow"><span class="wbtn sec">&plus; Add</span><span class="whint">One line <b>or comma</b> = one fabric.</span></div>
                  <div class="wfoot"><span class="wback">&larr; Back</span><span class="wbtn">Continue &rarr;</span></div>
                </div>
                ...
                <div class="wsc scE">
                  ...
                  <div class="fld" style="margin-top:.5rem"><label>Fabrics (one per line or comma-separated)</label>
                    <div class="ta wta f5" style="min-height:6.4rem"><span class="ph">&hellip;</span><span class="val">[FW 35mm String]<br>Plain White<br>Plain Cream<br>[FW 50mm Tape]<br>Cherry<br>Mahogany</span></div></div>
                  ...
                  <div class="okbanner" style="margin-top:.4rem"><b>&check;</b> Added 84 to Band A across 2 systems. Skipped 2 (likely duplicates).</div>
                ...
                <div class="wsc scF">
                  <div class="wtile"><div class="icon">&#128203;</div><h3>One thing left &mdash; price tables</h3>
                    <p>3 of 6 filled in. Click <em>Fill in</em> on each to type or paste prices straight from a supplier sheet.</p></div>
                  <div class="wcard blue"><div class="wh2">Got a price spreadsheet? Import it</div>
                    <p class="wlede">Upload your width &times; drop price grid for a system (all its bands in one file) and we&rsquo;ll
                       create and fill its tables in one go. Do each system in turn.</p>
                    <div class="wbtnrow"><span class="wbtn">Import Standard &rarr;</span><span class="wbtn">Import Motorised &rarr;</span></div></div>
                  <div class="wcard amber"><div class="wh2">8 price tables need setting up</div>
                    ...
                    <div class="wbtnrow"><span class="wbtn">Create all 8 empty price tables</span></div>
                ...
                <div class="wsc scH">
                  <div class="wtile done"><div class="icon">&#127881;</div><h3>All set &mdash; Roller Blind is ready to quote</h3>
                    <p>Product, 2 systems, 42 fabrics, and all 6 price tables filled in.</p></div>
                  ...
                  <div class="wcard amber" style="margin-top:.7rem"><div class="wh2">Continue an in-progress product</div>
        ...
        'body'    => '
          ...
          <ul class="steps">
            ...
            <li>Paste the same name twice and it tells you what it skipped: <code>Added 4 systems. Skipped 1 (already on this product).</code>
                Before you add anything the list reads <code>No systems yet &mdash; add at least one below.</code></li>
          ...
          <ul class="steps">
            ...
            <li><b>The paste box</b> takes one name per line <b>or</b> comma-separated &mdash; whichever your list is in. Or use
                ...
                <code>[FW 35mm String]</code> / <code>Plain White</code> / <code>Plain Cream</code> / <code>[FW 50mm Tape]</code> /
                <code>Cherry</code>. A header it doesn&rsquo;t recognise is reported back by name:
                <code>Unknown system names: "Forest Wood 35mm".</code></li>
            ...
            <li>Above the list sits the count &mdash; <em>42 fabrics added</em> &mdash; with a red <b>Delete all</b> guarded by
                <em>Delete ALL 42 fabrics on this product? Cannot be undone.</em> Each row shows its band, its colour, and either a purple
                <em>&lt;System&gt; only</em> or a faint <em>all systems</em>.</li>
          </ul>
          <div class="oops"><b>If it won&rsquo;t add:</b> <code>Band code is required (e.g. A, B, C, or Standard, Special).</code> &middot;
          ...
          <div class="heads"><span class="hi">&#9888;</span><div><b>The band trap &mdash; the one thing that catches everybody.</b> The band on
             ...
             <code>No price table for Roller Blind band Plain on system &lsquo;Standard&rsquo;.</code> <b>Spelling and spacing</b> have to match;
             capitals do <em>not</em> matter. Two ways to never hit it: pick from the band box&rsquo;s suggestion list, or take the
          ...
          <ul class="steps">
            <li><b>The tile at the top</b> tells you where you stand &mdash; amber <b>&ldquo;One thing left &mdash; price tables&rdquo;</b> with
                the exact reason (<code>3 of 6 filled in&hellip;</code>, or <code>No bands yet &mdash; that&rsquo;s fine&hellip;</code>, or
            ...
            <li><b>Typing them yourself?</b> The amber card lists the missing <em>&lt;System&gt; &plus; Band A</em> rows and
                <b>Create all 8 empty price tables</b> makes the lot: <em>One click &mdash; the empty grids appear instantly. Leave any out
                that don&rsquo;t apply to what you sell.</em></li>
          ...
          <p><b>Finishing, and coming back.</b> The footer has <b>&larr; Back to fabrics</b> and <b>Open product edit page &rarr;</b> (which
             ...
             close the tab, and next time you open the wizard the amber <b>&ldquo;Continue an in-progress product&rdquo;</b> card at the top lists
             what is unfinished &mdash; <em>Roller Blind &mdash; needs system &plus; fabric &plus; price table</em> &mdash; with a
             <b>Resume &rarr;</b> button that drops you at the exact step that product needs next.</p>
          ...
          <p><b>What the wizard deliberately leaves out.</b> There is no options step, no supplier, no discount and no markup &mdash; those all
             ...
             <em>Importing fabrics</em> and <em>Combining products</em>.</p>',
        'script'  => [
            ...
            ['1:35', 'Three escape hatches, and the paste slip.', 'Three ways out of typing. If another product already has this exact range, copy it across, bands and all. If your colours only come on certain systems, put the system name in square brackets above each batch and paste the whole lot in one go — miss the brackets and pick no system, and it tells you exactly that. Fix it, and eighty-four go in across two systems. And if this is a headrail or spares with no fabric at all, the no fabrics skip button takes you straight to prices. There is also a price tables first shortcut, which imports the grid so the band box can suggest the bands back to you.', 5],
