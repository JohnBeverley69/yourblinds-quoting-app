...
$T['vogue_split_1wand'] = [
    ...
    // Rows 50–72 extend cover to 5505mm (Louvolite p.43; the seed previously stopped
    // at 48 = 3673mm, which is why wider wand-centre blinds returned no trucks). The
    // 87mm column is INTERPOLATED (midpoint of 85/89) because the Best Fit PDF prints
    // 87 = 85 for these rows, which is corrupt (an 87mm carrier always covers more
    // than 85mm). 83/85/89 are as printed — swap in the real Louvolite 87mm figures
    // (CD S280201) when available.
    50=>[3501,3608,3717,3826], 52=>[3641,3752,3866,3979], 54=>[3780,3896,4014,4131], 56=>[3919,4039,4162,4284],
    58=>[4058,4183,4310,4436], 60=>[4198,4327,4458,4589], 62=>[4337,4470,4606,4742], 64=>[4476,4614,4754,4894],
    66=>[4616,4758,4903,5047], 68=>[4755,4901,5050,5199], 70=>[4894,5045,5199,5352], 72=>[5034,5189,5347,5505],
];
