                            ...
                            <div id="ampm-windows" class="ampm-windows">
                                ...
                                <label class="ampm-opt<?= $info['full'] ? ' is-full' : '' ?><?= $checked ? ' is-selected' : '' ?>"
                                    ...
                                    <span class="ampm-count" data-window="<?= e($wk) ?>">
                                        <?= $info['full'] ? 'Full' : e($info['remaining'] . ' of ' . $info['capacity'] . ' left') ?>
                                    </span>
                                </label>
                                <?php endforeach; ?>
                            </div>
    ...
    (function () {
        ...
        function apply(data) {
            ...
            Object.keys(data.windows).forEach(function (wk) {
                ...
                if (count) count.textContent = info.full ? 'Full' : (info.remaining + ' of ' + (info.capacity != null ? info.capacity : data.capacity) + ' left');
            });
            syncSelected();
        }
